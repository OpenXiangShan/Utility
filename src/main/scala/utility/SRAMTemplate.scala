...
import utility.SRAMTemplate.{nodeId, wrapperId}
...
println(s"core addSink-------------------------------------------sram_wrapperId_sigName is sram_${wrapperId}_${sigName}")
...
println(s"core addSource-------------------------------------------sram_idx+firstToBeBroadCast_sigName is sram_${idx + firstToBeBroadCast}_${sigName}")
println(s"core addSource-------------------------------------------idx is ${idx}")
println(s"core addSource-------------------------------------------firstToBeBroadCast is ${firstToBeBroadCast}")
...
println(s"core-----------------------------------------------------   firstToBeBroadCast is ${firstToBeBroadCast}")
...
//  println(s"running printing LiHe singlePort is $singlePort , bypassWrite is $bypassWrite ")
...
//println(s"---------------------------------------------------------SRAM NO running printing LiHe wrapperId is ${wrapperId}")
  ...
  //if (hasMbist && hasShareBus) {
//  println(s"running printing LiHe hasMbist is ${hasMbist} and hasShareBus is${hasShareBus}")
...
//println(s"---------------------------------------running printing LiHe nodeId is ${nodeId}")
...
println(s"core---------------------------------------------------------SRAM NO running printing LiHe nodeId is ${nodeId}")
println(s"core---------------------------------------------------------SRAM NO running printing LiHe wrapperId is ${wrapperId}")
println(s"core---------------------------------------------------------SRAM NO running printing LiHe domainId is ${SRAMTemplate.getDomainID}")
//println(s"---------------------------------------------------------SRAM NO running printing LiHe firstToBeBroadCast is ${firstToBeBroadCast}")
...
(
  ...
  val array = Module(new SRAMTemplate(gen, set=nRows, way=width*way,
    ...
    hasMbist = hasMbist, hasShareBus = hasShareBus, parentName = parentName , bypassWrite = bypassWrite
  ))
